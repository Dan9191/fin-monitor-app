...
function initCategoryChart(chartId, categoryData) {
    ...
    // Цвета для категорий (можно настроить по своему вкусу)
        ...
        options: {
            ...
            plugins: {
                legend: {
                    ...
                    labels: {
                        font: {
                            size: 16, // Увеличиваем размер шрифта легенды
                            family: "'Helvetica Neue', 'Helvetica', 'Arial', sans-serif",
                            weight: 'bold'
                        },
                        padding: 20 // Увеличиваем отступы между элементами легенды
                    }
                },
                tooltip: {
                    titleFont: {
            ...
            // Увеличиваем размер шрифта на самих сегментах (если используете doughnut)
            datalabels: {
                display: true,
                color: '#fff',
                font: {
